    ...
    private void helpButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_helpButtonActionPerformed
        if (loggedUser.getRole() == 3) //Cliente
            JOptionPane.showMessageDialog(null, "Este programa permite las siguientes opciones: \n"
                    ...
                    + "- Pulsa el icono de la casilla con un tick para acceder a tu listado de reservas y "
                    + "hacer nuevas o cancelarlas.\n"
            ...
            JOptionPane.showMessageDialog(null, "Este programa permite las siguientes opciones: \n"
                    ...
                    + "- Pulsa el icono de la casilla con un tick para acceder a tu jornada laboral.\n"
                    + "- Pulsa el icono del calendario para ver el horario del gimnasio"
                    + "(todas las actividades ordenadas por fecha).\n"
